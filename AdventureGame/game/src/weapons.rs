...
pub struct MeleeWeapon{
    ...
    two_handed: bool,
    throwable: bool,
    dice_to_roll: i8, //this is the amount of times to roll the roll_max eg 2d8 will roll a 8 sided die 2 times.
    roll_max: i8,  //this is the max its damage can roll. eg 1d6 will roll between a 0-6
    damage_type: String,
    cost: i32,
}
